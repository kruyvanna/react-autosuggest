          ...
          return (
            ...
            a(t, [
              ...
              },
              {
                ...
                value: function(e) {
                  (0, h.default)(e.suggestions, this.props.suggestions)
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (!(0, h.default)(o, e.suggestions) && o.length > 0 && r)
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    p = t.alwaysRenderSuggestions,
                    S = t.highlightFirstSuggestion,
                    I = this.state,
                    b = I.isFocused,
                    w = I.isCollapsed,
                    x = I.highlightedSectionIndex,
                    _ = I.highlightedSuggestionIndex,
                    O = I.valueBeforeUpDown,
                    C = p ? y : this.props.shouldRenderSuggestions,
                    j = u.value,
                    P = u.onFocus,
                    k = u.onKeyDown,
                      ...
                      onKeyDown: function(t, o) {
                        ...
                        switch (r) {
                          ...
                          case 13:
                            ...
                            if ((T && !p && e.closeSuggestions(), null != l)) {
                              var c = h(l);
                          ...
                          case 27:
                            ...
                            if (null === O) {
                              if (!g) {
                                var f = '';
                                e.maybeCallOnChange(t, f, 'escape'),
                                  C(f)
                                    ? i({ value: f, reason: 'escape-pressed' })
                                    : e.onSuggestionsClearRequested();
                              }
                  ...
                  return g.default.createElement(m.default, {
                    ...
                    theme: (0, v.mapToAutowhateverTheme)(d),
                    id: c,
